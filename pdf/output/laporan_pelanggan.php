...
$html = '<p align="center"><strong><bold>Laporan Pelanggan</strong></b></p></br>
...
while($bayar=mysqli_fetch_array($query)){
    $html.='
    <tr>
    <td>'.$bayar['PelangganID'].'</td>
    <td>'.$bayar['NamaPelanggan'].'</td>
    <td>'.$bayar['Alamat'].'</td>
    <td>'.$bayar['NomorTelepon'].'</td>
    </tr>
    ';
